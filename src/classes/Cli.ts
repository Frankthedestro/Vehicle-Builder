    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.vehicleType === 'Car') {
          // create a car
          this.createCar();
        // added statments to create a truck or motorbike based on user selection
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        //  After calling the findVehicleToTow method,
        ...
        // added statements to perform the wheelie action only if the selected vehicle is a motorbike
